...
namespace WebASP_CoreMVC.Controllers
{
    ...
    {
        private readonly WebASP_CoreMVCContext _context;

        public DepartamentsController(WebASP_CoreMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departament != null ? 
                          ...
                          Problem("Entity set 'WebASP_CoreMVCContext.Departament'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebASP_CoreMVCContext.Departament'  is null.");
            }
            var departament = await _context.Departament.FindAsync(id);
            if (departament != null)
            {
